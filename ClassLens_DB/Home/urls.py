...
from Home.views import getDepartments,registerNewStudent,mark_attendance,teacher_profile,registerNewTeacher,validateStudent,validateTeacher,send_otp,verify_otp,set_password,get_subject_details,verify_email, verify_prn, get_student_attendance,attendance_status,teacher_subjects, get_list,change_attendance
...
urlpatterns=[
    ...
    path('getAbsenteesList/',get_list, name='get_absentees_list'),
