...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('subjectAttendancePercentage', models.JSONField(blank=True, default=dict, null=True)),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Home.student')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddIndex(
            model_name='student',
            index=pgvector.django.indexes.HnswIndex(ef_construction=200, fields=['face_embedding'], m=16, name='student_face_embedding_idx', opclasses=['vector_l2_ops']),
        ),
